...
class BaseTrainer:
    ...
    # Focal Dice Loss
    def focal_dice(y_true, y_pred, alpha=0.25, gamma=2):
        focal_loss_fn = FocalLoss(gamma=gamma, alpha=alpha)
        return dice_coef_loss(y_true, y_pred) + focal_loss_fn(y_true, y_pred)
    ...
    # Multi-Loss combining BCE, Focal, and Dice Loss
    def multi_loss(y_true, y_pred, alpha=0.25, gamma=2.0):
        # BCE Loss
        ...
        # Return the sum of the three losses
        return bce + focal + dice

    def set_loss_fn(self):
        self.seg_loss = multi_loss
